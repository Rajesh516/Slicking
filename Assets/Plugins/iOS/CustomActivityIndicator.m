...
//  Unity-iPhone
//
//  Created by Gazal Kochar on 12/06/13.
//
//
...
@interface CustomActivityIndicator(Private)
...
static CustomActivityIndicator *activityView = nil;
...
+ (id)newActivityViewWithLabel:(NSString*)labelText width:(NSUInteger)labelWidth;
{
    ...
    CustomActivityIndicator *activityView = [[self alloc] initWithLabel:labelText width:labelWidth];
...
//	self.originalView = [TwitterManager unityViewController].view;
...
@implementation CustomWhiteActivityIndicator
...
@implementation CustomBezelActivityIndicator
...
@implementation CustomImageActivityIndicator
...
{
	CustomImageActivityIndicator *activityView = [[self alloc] initWithLabel:labelText width:labelWidth withImage:image];
	[activityView setupActivityIndicatorAndAnimateShow];

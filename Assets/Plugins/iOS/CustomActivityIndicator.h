...
+ (CustomActivityIndicator*)currentActivityView;
...
@interface CustomWhiteActivityIndicator : CustomActivityIndicator
{
}
...
@interface CustomBezelActivityIndicator : CustomActivityIndicator
{
}
...
@interface CustomImageActivityIndicator : CustomBezelActivityIndicator
{
}

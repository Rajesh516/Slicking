...
public class GUIManager : MonoBehaviour 
{
	...
	public void ButtonUp(Transform button)
	{
		...
		switch (button.name)
		{
			...
			case "Purchases":
				UIManager.Instance.ShowPurchaseScreen ();
				break;

			case "Setting":
				MainMenuManager.Instance.ShowArrowMenu ();
				break;
			...
			case "AskMeLater":
				MainMenuManager.Instance.HideArrowMenu ();
				break;

			case "Character":
				UIManager.Instance.ShowCharacterScreen ();
				break;
	...
	public void ShowEnd()
	{
       ...
       // finishTexts[1].text = currentCoins.ToString();
		...
		powerUpManager.Instance.StopAllPowerUpCoroutines ();
	}
